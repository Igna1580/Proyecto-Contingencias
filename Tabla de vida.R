...
df_ingresos_simulados_H <- tibble(
  ...
  rowwise() %>%
  mutate(
    Ing_estim_0 = prima_hombres_anual*mean(v_pob_64menos_xaño_0_H[[Año+1]]),
    Perc_99.5_0 = prima_hombres_anual*quantile(v_pob_64menos_xaño_0_H[[Año+1]],0.995),
    Ing_estim_1 = prima_hombres_anual*mean(v_pob_64menos_xaño_1_H[[Año+1]]),
    Perc_99.5_1 = prima_hombres_anual*quantile(v_pob_64menos_xaño_1_H[[Año+1]],0.995),
    Ing_estim_2 = prima_hombres_anual*mean(v_pob_64menos_xaño_2_H[[Año+1]]),
    Perc_99.5_2 = prima_hombres_anual*quantile(v_pob_64menos_xaño_2_H[[Año+1]],0.995)
  )
...
df_ingresos_simulados_M <- tibble(
  ...
  rowwise() %>%
  mutate(
    Ing_estim_0 = prima_mujeres_anual*mean(v_pob_64menos_xaño_0_M[[Año+1]]),
    Perc_99.5_0 = prima_mujeres_anual*quantile(v_pob_64menos_xaño_0_M[[Año+1]],0.995),
    Ing_estim_1 = prima_mujeres_anual*mean(v_pob_64menos_xaño_1_M[[Año+1]]),
    Perc_99.5_1 = prima_mujeres_anual*quantile(v_pob_64menos_xaño_1_M[[Año+1]],0.995),
    Ing_estim_2 = prima_mujeres_anual*mean(v_pob_64menos_xaño_2_M[[Año+1]]),
    Perc_99.5_2 = prima_mujeres_anual*quantile(v_pob_64menos_xaño_2_M[[Año+1]],0.995)
  )
...
df_beneficios_simulados_H <- tibble(
  ...
  rowwise() %>%
  mutate(
    Benef_estim_1 = A*mean(v_pob_65mas_xaño_1_H[[Año+1]]),
    Perc_99.5_1 = A*quantile(v_pob_65mas_xaño_1_H[[Año+1]],0.995),
    Benef_estim_2 = B*mean(v_pob_65mas_xaño_2_H[[Año+1]]),
    Perc_99.5_2 = B*quantile(v_pob_65mas_xaño_2_H[[Año+1]],0.995),
    Benef_estim_3 = C*mean(v_pob_65mas_xaño_3_H[[Año+1]]),
    Perc_99.5_3 = C*quantile(v_pob_65mas_xaño_3_H[[Año+1]],0.995),
    Benef_estim_4 = D*mean(v_pob_65mas_xaño_4_H[[Año+1]]),
    Perc_99.5_4 = D*quantile(v_pob_65mas_xaño_4_H[[Año+1]],0.995)
  )
...
df_costos_simulados_H <- tibble(
  ...
  rowwise() %>%
  mutate(
    Costo_estim_0 = 0.05*prima_anual*mean(v_pob_64menos_xaño_0_H[[Año+1]]),
    Perc_99.5_0 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_0_H[[Año+1]],0.995),
    Costo_estim_1 = 0.05*prima_anual*mean(v_pob_64menos_xaño_1_H[[Año+1]]),
    Perc_99.5_1 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_1_H[[Año+1]],0.995),
    Costo_estim_2 = 0.05*prima_anual*mean(v_pob_64menos_xaño_2_H[[Año+1]]),
    Perc_99.5_2 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_2_H[[Año+1]],0.995)
  )
...
df_beneficios_simulados_M <- tibble(
  ...
  rowwise() %>%
  mutate(
    Benef_estim_1 = A*mean(v_pob_65mas_xaño_1_M[[Año+1]]),
    Perc_99.5_1 = A*quantile(v_pob_65mas_xaño_1_M[[Año+1]],0.995),
    Benef_estim_2 = B*mean(v_pob_65mas_xaño_2_M[[Año+1]]),
    Perc_99.5_2 = B*quantile(v_pob_65mas_xaño_2_M[[Año+1]],0.995),
    Benef_estim_3 = C*mean(v_pob_65mas_xaño_3_M[[Año+1]]),
    Perc_99.5_3 = C*quantile(v_pob_65mas_xaño_3_M[[Año+1]],0.995),
    Benef_estim_4 = D*mean(v_pob_65mas_xaño_4_M[[Año+1]]),
    Perc_99.5_4 = D*quantile(v_pob_65mas_xaño_4_M[[Año+1]],0.995)
  )
...
df_costos_simulados_M <- tibble(
  ...
  rowwise() %>%
  mutate(
    Costo_estim_0 = 0.05*prima_anual*mean(v_pob_64menos_xaño_0_M[[Año+1]]),
    Perc_99.5_0 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_0_M[[Año+1]],0.995),
    Costo_estim_1 = 0.05*prima_anual*mean(v_pob_64menos_xaño_1_M[[Año+1]]),
    Perc_99.5_1 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_1_M[[Año+1]],0.995),
    Costo_estim_2 = 0.05*prima_anual*mean(v_pob_64menos_xaño_2_M[[Año+1]]),
    Perc_99.5_2 = 0.05*prima_anual*quantile(v_pob_64menos_xaño_2_M[[Año+1]],0.995)
  )
